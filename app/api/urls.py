...
ProductListCreateAPIView,ProductRetrieveUpdateAPIView,ProductRetrieveDestroyAPIView,ProductRetrieveUpdateDestroyAPIView,CompanyRetrieveUpdateDestroyAPIView)
